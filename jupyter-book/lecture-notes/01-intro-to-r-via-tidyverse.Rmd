...
<!-- #region slideshow={"slide_type": "slide"} -->
```{admonition} Clicker 1: So, who has used R before?
...
```{admonition} Clicker 5: Above data is tidy, true or false?
...
```{admonition} Clicker 6: Above data is tidy, true or false?
...
```{admonition} Clicker 7: Above data is tidy, true or false?
...
```{admonition} Clicker 8: Above data is tidy, true or false?
