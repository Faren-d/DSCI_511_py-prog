...
```{r}
library(tidyverse)
vancouver_parks <- read_delim("https://opendata.vancouver.ca/api/explore/v2.1/catalog/datasets/parks-washrooms/exports/csv?lang=en&timezone=America%2FLos_Angeles&use_labels=true&delimiter=%3B",
          delim = ";")
#glimpse(vancouver_parks)

num_distinct_rows <- distinct(vancouver_parks, ParkID) |> nrow()
num_distinct_rows
num_total_rows <- nrow(vancouver_parks)
num_total_rows
```
